...
Nowadays logistics enterprises provide mass customization logistics services(MCLS) which allows customer to  request customization service or mass service. To provide better service, the logistics service integrator need to reduce the cost, satisfy the customers' time requirement and keep functional logistic service providers satisfied. Our report focus on the schedule model in the two-echelon logistic service supply chain. In this problem
...
In this problem we consider a fixed CODP. For example 
